...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        products = [
            {
                'name': 'Kashmir Winter Jacket',
                'description': 'Heavy-duty winter jacket designed for extreme cold in Kashmir. Features thermal insulation, waterproof exterior, and snow protection.',
                'category': 'Outerwear',
                'price': 89.99,
            ...
            },
            {
                ...
                'description': 'Warm hiking cargo pants for cold mountain regions like Kashmir, Manali. Suitable for winter trekking with thermal lining.',
                'category': 'Bottoms',
                'price': 54.99,
